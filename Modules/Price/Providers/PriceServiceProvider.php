...
use Modules\Price\Repositories\PriceRepositoryEloquent;
...
class PriceServiceProvider extends ServiceProvider
{
     ...
     */
    protected string $moduleName = 'Price';

    /**
     * @var string $moduleNameLower
     */
    protected string $moduleNameLower = 'price';
    ...
    public function register(): void
    {
        ...
        $this->app->bind(PriceRepository::class, function () {
            return new PriceRepositoryEloquent(new Price());
        });
    }
